...
.metric-card,.panel{border-color:#e5e8e6;border-radius:11px;box-shadow:0 5px 18px rgba(32,44,38,.035)}
.metric-card{min-height:118px;padding:17px}.metric-card p,.panel-header p,.action-panel p{color:#7c827e}.metric-card strong,.panel-header h3,.action-panel h3,.bar-row>strong{color:#242824}
.metric-icon{width:40px;height:40px;border-radius:10px}.blue{color:#52776a;background:#e8f1ed}.violet{color:#7a6f8f;background:#f0edf4}.green{color:#518267;background:#e8f3ec}.amber{color:#9a7a42;background:#f7f1e5}.red{color:#a26161;background:#f8ebeb}
.action-panel{color:#25342e;background:#eef3f0;border:1px solid #dfe7e3}.action-panel::after{border-color:rgba(54,76,66,.05)}.action-panel h3{color:#25342e}.action-panel p{color:#68746e}.action-symbol{color:#506a60;background:#dde9e3}.action-panel .primary-button{color:#fff;background:#344b42;border-color:#344b42}
.panel-badge,.rank{color:#536a61;background:#edf2ef}.text-button{color:#536a61}.bar-track{background:#eff1ef}.negative-count{color:#a75a5a;background:#faeeee}
</style>
