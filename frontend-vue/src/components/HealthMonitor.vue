...
.monitor-loading,.monitor-error,.service-card,.explanation{border-color:#e5e8e6;border-radius:11px;box-shadow:0 5px 18px rgba(32,44,38,.035)}
.health-summary{color:#416c55;background:#edf5f1;border-color:#d6e8de;border-radius:11px}.health-summary.degraded{color:#80683e;background:#faf5e9;border-color:#ede0bd}.health-symbol{background:#6b9a7f;border-radius:11px}.degraded .health-symbol{background:#b18a4e}.service-icon,.explanation>div{color:#587368;background:#e7efeb}.service-status.ok{color:#4d7a61;background:#e5f3eb}.service-status.degraded{color:#8c7040;background:#f7f1df}
</style>
